...
def _one(ticker: str) -> dict:
    ...
    try:
        ...
        # EV/Sales: the fallback valuation metric when a company is
        # loss-making and P/E / PEG are not meaningful.
        ev_sales = None
        ...
        out.update({
            ...
            "debt": debt, "debt_equity": debt_equity, "cash": cash, "pe": pe,
            "forward_pe": forward_pe, "peg": peg, "ev_sales": ev_sales, "market_cap": market_cap,
            "sector": sector,
        })
